<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DistrictMaster.master" AutoEventWireup="true" EnableEventValidation="false" CodeFile="frm_Registration.aspx.cs" Inherits="District_frm_Registration" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $.ajax({
                type: "POST",
                url: "frm_Registration.aspx/GetRegCode",
                data: '{}',
    ...
    <script type="text/javascript">
        function clearTextBox() {
            ...
            $('#<%=txtVoterIdCard.ClientID%>').val('');
            $('#<%=txtKisanCreditCard.ClientID%>').val('');
...
$(document).ready(function () {
                ...
                if (
                    ...
                    if (isValid) {
                        ...
                        if (regCode == "") {
                            ...
                            appReg.DateofBirth = $('#<%=txtDateofBirth.ClientID%>').val();
                            appReg.VoterIdCard = $('#<%=txtVoterIdCard.ClientID%>').val();
                            appReg.KisanCreditCard = $('#<%=txtKisanCreditCard.ClientID%>').val();
    ...
    <script type="text/javascript">
        function getApplicantDetail() {
            ...
            if (regCode > 0) {
                    ...
                    success: function (data) {
                        if (data.d != "") {
                            ...
                            $.each(applicantReg, function (index, value) {
                                $('#<%=lblRegistrationDate.ClientID%>').text(value.RegistrationDate);
                            ...
                            var landFoot = "<tr><td colspan = 2 class='text-right'><b>कुल योग</b></td> <td style='text-align:right'><b>" + totolArea.toFixed(2) + "</b></td> <td></td> </tr>";
                            $('#tblLandDet tfoot').empty();
                ...
                alert('कृपया पंजीकरण संख्या चुनें।');
            }
        }
    </script>
    <script type="text/javascript">
    ...
    <script type="text/javascript">
        function ShowVillagePopup()
        {
            var blockkey = $('#ContentPlaceHolder1_ddlBlockName option:selected').val();
            if (blockkey > 0) {
        ...
        function AddVillage() {
            var blockkey = $('#ContentPlaceHolder1_ddlBlockName option:selected').val();
            var villagename = $('#txtNewVillageName').val();
            if (villagename!='') {
                $.ajax({
                    type: "Post",
                    contentType: "application/json; charset=utf-8",
                    url: "frm_Registration.aspx/AddVillageName",
                    data: '{bkey: "' + blockkey + '",vname: "' + villagename + '"}',
                    dataType: "json",
                    success: function (data) {
                        loadVillageBlock();
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="row mar-top">
                                            ...
                                            <div class="col-lg-4">
                                                <fieldset>
                                                    <div class="form-group">
                                                        <label class="col-lg-4 control-label">पंजीकरण दिनांक </label>
                                                        <div class="col-lg-6">
                                                          <asp:Label ID="lblRegistrationDate" runat="server" Text="" CssClass="form-control"></asp:Label>
                                                        </div>
                                                    </div>
                                                </fieldset>
                                            </div>
                                    ...
                                    <div class="panel-body">
                                                        ...
                                                        <div class="col-lg-7">
                                                            <div class="input-group mar-btm">
                                                                ...
                                                                <span class="input-group-btn">
                                                                    <a class="btn btn-danger btn-labeled"  id="ancAddVillage" data-toggle="modal" onclick="ShowVillagePopup()"><i class="fa fa-plus"></i></a>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <fieldset>
                                                    <div class="form-group">
                                                        <label class="col-lg-3 control-label">वोटर आई० डी०</label>
                                                        <div class="col-lg-7">
                                                            <asp:TextBox ID="txtVoterIdCard" runat="server" placeholder="वोटर आई० डी" CssClass="form-control"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                </fieldset>
                                            </div>
                                            <div class="col-lg-4">
                                                <fieldset>
                                                    <div class="form-group">
                                                        <label class="col-lg-3 control-label">किसान क्रेडिट कार्ड </label>
                                                        <div class="col-lg-7">
                                                            <asp:TextBox ID="txtKisanCreditCard" runat="server" placeholder="किसान क्रेडिट कार्ड" CssClass="form-control"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                </fieldset>
                                            </div>
                                            <div class="col-lg-4">
                                                <fieldset>
                                                    <div class="form-group">
                                                        <label for="demo-msk-date" class="col-md-3 control-label">जन्म तिथि</label>
                                                        <div class="col-md-7">
                                                            <asp:TextBox ID="txtDateofBirth" runat="server" placeholder="dd/mm/yyyy" data-mask="99/99/9999" CssClass="form-control"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                </fieldset>
                                            </div>
                                            ...
                                            <div class="col-lg-3">
                                                <fieldset>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-7">
                                                            <asp:TextBox ID="txtGataKhatauniNo" runat="server" placeholder="घाटा/खतौनी संख्या" CssClass="form-control" ></asp:TextBox>
                                                        </div>
                                                    </div>
                                                </fieldset>
                                            </div>
                                            ...
                                            <div class="col-lg-2">
                                                <fieldset>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <asp:TextBox ID="txtArea" runat="server" placeholder="क्षेत्रफल" CssClass="form-control"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                </fieldset>
                                            </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" onclick="AddVillage()">सुरक्षित करें</button>
                    </div>
                </div>
            </div>
        </div>
