<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DivisionMaster.master" AutoEventWireup="true" CodeFile="frmVerificationReport.aspx.cs" Inherits="Division_frmVerificationReport" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                url: "frmVerificationReport.aspx/GetForwardInstallment",
                data: '{}',
                dataType: "json",
                success: function (data) {
                    ...
                    $.each(mst, function (index, value) {
                        ...
                        row = row + '<td style="text-align: right">' + parseFloat(value.InstallmentAmount).toFixed(2) + '</td>'
                    ...
                    if (id == 1) {
                        ...
                        var frow = '<tr><td colspan=6 style = "text-align:right"><b>कुल योग</b></td><td colspan=1 style="text-align: right"><b>' + InsTotal.toFixed(2) + '</b></td><td></td><tr>';
                        $('#tblIsForwarded tfoot').empty();
                        $('#tblIsForwarded tfoot').append(frow);
                    }
