<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DivisionMaster.master" AutoEventWireup="true" CodeFile="StatusUpdate.aspx.cs" Inherits="Division_StatusUpdate" %>
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $('#<%=txtDOB.ClientID %>').text(date.getDate() + '/' + ((date.getMonth() + 1) < 10 ? '0' + (date.getMonth() + 1) : (date.getMonth() + 1)) + '/' + date.getFullYear()).trigger('change').attr('disabled', true);
                               ...
                               if (response.d['District_Flag'] > 2) {
                                   $('#<%=chkDeclaration.ClientID %>').attr('disabled', true);
                             }
                        if (response.d['ApplicationStatus'] > 6) {
                            $('#<%=chkDeclaration.ClientID %>').attr('disabled', true);
                                   $('#<%=txtRemarkdetails.ClientID %>').attr('disabled', true);
            ...
            $('#<%=Applicationdocid.ClientID %>').text($(row).find('td:eq(1)').text());
              ...
              $.ajax({
                  ...
                  success: function (response) {
                      ...
                      $('#<%=lblSchemename.ClientID %>').text(response.d["SchemeName"]);
          ...
          function UpdateRejectionwithremark() {
              if (!confirm('Do you want to update Application Attachment Status?')) {
                  ...
                  if (!($('#<%=chkDeclaration1.ClientID %>').is(':checked'))) {
                      ...
                      ApplicantSchemeRegistration.District_Flag = '4';
                  ...
                  $.ajax({
                      ...
                      success: function (r) {
                          if (r.d.length > 0) {
                              ...
                              if (r.d[0].District_Flag == 3) {
                                  $('#<%= verifyform.ClientID %>').text("Already Verify");

                          }
                          else if (r.d[0].District_Flag == 4) {
                              $('#<%= verifyform.ClientID %>').text("Already Verify");
     ...
     function printform() {
      ...
      function Updatestatusapplicant() {
          if (!confirm('Do you want to update Or Verify Application View?')) {
            ...
            ApplicantSchemeRegistration.ApplicationNo = x
            ApplicantSchemeRegistration.District_Flag = '3';
                                        ...
                                        <asp:Repeater runat="server" ID="rptApplication">
                                                ...
                                                <table class="table table-striped table-bordered table-hover table-full-width text-black"
                                                    ...
                                                    <thead>
                                                        <tr class="info">
                                                            ...
                                                            <th style="width: 8%" class="text-center">District Doc
                                                            </th>
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    id="hidCategory" />--%>
                                                        <input type="hidden" value='<%# DataBinder.Eval(Container.DataItem,"AadharNo") %>'
                                                            id="hidAadhar" />
                                          ...
                                          &nbsp; 
                                                <a id="lnkDocView" name="lnkDocView" href="javascript:void(0)" onclick='viewdocs(this);' data-toggle="modal"
                                                    ...
                                                    <td style="width: 5%" class="text-center">
                                                        <div class='<%# (DataBinder.Eval(Container.DataItem, "LevelTo").ToString()=="DLSC")?"":"hidden"%>'>
                                                    ...
                                                    <td style="width: 10%" class="text-center">
                                                        <a data-placement="top" href="../uploadfiles/DVIOuploadfile/<%# DataBinder.Eval(Container.DataItem,"FileName") %> " target="blank"><%# DataBinder.Eval(Container.DataItem,"FileName") %></a>
                                                    </td>
                                                    <td style="width: 10%" class="text-center">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <asp:CheckBox runat="server" ID="chkDeclaration1" Text="&nbsp; I am verify that all the document is correct ." onChange="viewremark();"
                                                        CssClass="form-control blue-border required" />
