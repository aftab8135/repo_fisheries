<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DistrictMaster.master" AutoEventWireup="true" CodeFile="~/District/SchemeStatus.aspx.cs"
    Inherits="District_SchemeStatus" %>
    ...
    <script type="text/javascript">
        function updateStatus() {
            ...
            if (objection || forworded) {
                ...
                schDet.IsForword = $("#chkForward").is(":checked");
                ...
                schDet.CurStatus = ($("#rbObjection").is(":checked") ? 38 : $("#rbStatus").is(":checked") ? 35 : 0);

                if (schDet.ObjForm || schDet.ObjAttach || schDet.IsForword) {
                    ...
                    //schDet.SurveryFileName = $("#rbStatus").is(":checked");
                    //schDet.SurveryFilePath = $("#rbStatus").is(":checked");
                    //schDet.OtherFileName = $("#rbStatus").is(":checked");
                    //schDet.OtherFilePath = $("#rbStatus").is(":checked");
                }
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                              <a href="javascript:void(0);" class="btn btn-xs btn-danger" data-placement="top"
                                                    ...
                                                    <%#(DataBinder.Eval(Container.DataItem, "CurrentStatus").ToString() == "Pending" ? "onclick='setSchemeBasic("+DataBinder.Eval(Container.DataItem, "ApplicationNo")+")'" : "disabled")%>>Update Status</a>
                                        </td>
                                    </tr>
                                </ItemTemplate>
                                <FooterTemplate>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <table class="table table-bordered text-black">
                                        <tbody>
                                            <tr>
                                                <td class="col-xs-6">
                                                    <input type="checkbox" id="chkForward" value="Forward To Division" />
                                                    Forward to Division
                                                </td>
                                            </tr>
                                        </tbody>
