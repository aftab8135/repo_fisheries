...
public partial class District_StatusUpdate : System.Web.UI.Page
{
    ...
    private void fillDataSearch(int schemevalue, int statuskey, DateTime fromdate, DateTime todate)
    {
        ...
        DataSet ds = db.GET_ApplicationList_DVIOSearh(Convert.ToInt16(3), Convert.ToInt16(schemevalue), Convert.ToInt16(statuskey), fromdate, todate);
    ...
    {
        DataSet ds = db.GET_ApplicationList(Convert.ToInt16(12));      
        if (ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            rptApplication.DataSource = ds.Tables[0];
        else
            rptApplication.DataSource = "";
    ...
    public static List<ApplicationStatus_Master> getCurrentStatus(Int32 q)
    {
        ...
        {
            lstApplicationStatus = db.ReadAllApplicationStatus(true, objDetail.ApplicationStatus, "DVIO");
        }
