<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/HOMaster.master" AutoEventWireup="true" CodeFile="frm_MSRTarget.aspx.cs" Inherits="MPR_frm_MSRTarget" %>
    ...
    <script type="text/javascript">
        function SeedDistribution() {
            ...
            if (ddl > 0) {
                ...
                //if (ddl == 1)
                //    row = row + '<th style="text-align: center; vertical-align: top">रियरिंग इकाई जो </th>'
                //else
                ...
                $.ajax({
                    type: "Post",
                    contentType: "application/json; charset=utf-8",
                    url: "frm_MSRTarget.aspx/GetSeedYearlyTarget",
            ...
            $("#btnSubmit").click(function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (r.StatusCode == "200") {
                            alert(r.Msg);
                            window.location.href = "frm_MSRTarget.aspx";
                        }
                        else {
                            alert(r.Msg);
                        }
