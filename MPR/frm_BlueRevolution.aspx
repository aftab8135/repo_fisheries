<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DistrictMaster.master" AutoEventWireup="true" CodeFile="frm_BlueRevolution.aspx.cs" Inherits="MPR_frm_BlueRevolution" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            if (schemetypeId > 0) {
                $.ajax({
                    type: "POST",
                    url: "frm_BlueRevolution.aspx/GetSchemeType",
            ...
            $.ajax({
                type: "POST",
                url: "frm_BlueRevolution.aspx/GetMonthName",
                data: '{}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (r) {
        ...
        $(document).ready(function () {
            $("#btnSubmit").click(function () {
                ...
                if (MonthId > 0 && SchemeSubTypeKey > 0) {
                    ...
                    var objBlueRevo = {};
                    objBlueRevo.MonthKey = parseInt(MonthId);
                    objBlueRevo.SchemeSubTypeKey = parseInt(SchemeSubTypeKey);
                    objBlueRevo.TotalApplicant = parseInt($('#txtTotalApplicant').val());
                    objBlueRevo.TotalArea = parseFloat($('#txtTotalArea').val())
                    objBlueRevo.TotalWorkStart = parseInt($('#txtWorkStart').val());
                    objBlueRevo.TotalCompletedWork = parseInt($('#txtWorkCompleted').val());
                    objBlueRevo.TotalAllocatedAmount = parseFloat($('#txtTotalAllocatedAmount').val());
                    objBlueRevo.TotalExpandAmount = parseFloat($('#txtTotalExpandAmount').val());
                    objBlueRevo.TotalExpandPercent = totalExpandPercent;

                    $.ajax({
                        type: "POST",
                        url: "frm_BlueRevolution.aspx/Create",
                        data: '{objBlueRevolution:' + JSON.stringify(objBlueRevo) + '}',
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
    ...
    <script type="text/javascript">
        function LoadRecords() {
            ...
            if (MonthId > 0 && SchemeSubTypeKey > 0) {
                $.ajax({
                    type: "POST",
                    url: "frm_BlueRevolution.aspx/Load_BlueRevolution",
                    data: '{schemesubtypekey : ' + parseInt(SchemeSubTypeKey) + ',monthkey:' + parseInt(MonthId) + '}',
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (r) {
                        var BR = r.d;
                        if (BR.BlueRevolutionKey > 0) {
                            $('#ContentPlaceHolder1_hidBlueRevolutionKey').val(BR.BlueRevolutionKey);
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="content-container">
        ...
        <div class="pageheader hidden-xs">
            <h3><i class="fa fa-home"></i>नीली क्रांति योजना </h3>
            <div class="breadcrumb-wrapper">
                <%-- <span class="label">You are here:</span>--%>
                <ol class="breadcrumb">
                    <li><a href="Dashboard.aspx">होम </a></li>
                    <li class="active">नीली क्रांति योजना </li>
                </ol>
            </div>
        </div>
        <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    ...
                    <div class="col-lg-12">
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title"><strong>नीली क्रांति योजना की भौतिकी एवं वित्तीय प्रगति </strong></h3>
                            </div>
                            <!--No Label Form-->
